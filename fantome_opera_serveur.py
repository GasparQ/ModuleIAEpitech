...
try:
    open('./0/infos.txt', 'w').close()
    open('./0/questions.txt', 'w').close()
    open('./0/reponses.txt', 'w').close()
    open('./1/infos.txt', 'w').close()
    open('./1/questions.txt', 'w').close()
    open('./1/reponses.txt', 'w').close()
except:
